declare namespace ArgoCD {
    ...
    export interface ApplicationResourceActionParameters {
        name?: string;
        value?: string;
    }
    export interface ApplicationResourceActionRunRequestV2 {
        action?: string;
        appNamespace?: string;
        group?: string;
        kind?: string;
        ...
        namespace?: string;
        project?: string;
        resourceActionParameters?: ApplicationResourceActionParameters[];
        resourceName?: string;
        version?: string;
    }
    ...
    export interface Applicationv1alpha1ResourceStatus {
         ...
         */
        group?: string;
        health?: /* HealthStatus contains information about the currently observed health state of a resource */ V1alpha1HealthStatus;
        /**
    ...
    export interface ClusterSettings {
        ...
        resourceOverrides?: {
            [name: string]: /* ResourceOverride holds configuration to customize resource diffing and health assessment */ V1alpha1ResourceOverride;
        };
    ...
    export interface V1LoadBalancerIngress {
         ...
         * +optional
         */
        ports?: /* PortStatus represents the error condition of a service port */ V1PortStatus[];
    }
    /**
    ...
    export interface V1NodeSystemInfo {
         ...
         */
        osImage?: string;
        swap?: /* NodeSwapStatus represents swap memory information. */ V1NodeSwapStatus;
        /**
    ...
    export interface V1alpha1ApplicationSetStatus {
         ...
         */
        resources?: /* ResourceStatus holds the current synchronization and health status of a Kubernetes resource. */ Applicationv1alpha1ResourceStatus[];
    }
    /**
    ...
    export interface V1alpha1ApplicationStatus {
         ...
         */
        controllerNamespace?: string;
        health?: /* AppHealthStatus contains information about the currently observed health state of an application */ V1alpha1AppHealthStatus;
        /**
    ...
    export interface V1alpha1ApplicationTree {
         ...
         */
        hosts?: /* HostInfo holds metadata and resource usage metrics for a specific host in the cluster. */ V1alpha1HostInfo[];
        /**
    ...
    export interface V1alpha1HostInfo {
         ...
         */
        resourcesInfo?: /* HostResourceInfo represents resource usage details for a specific resource type on a host. */ V1alpha1HostResourceInfo[];
    ...
    export interface V1alpha1ResourceNode {
        ...
        networkingInfo?: /* ResourceNetworkingInfo holds networking-related information for a resource. */ V1alpha1ResourceNetworkingInfo;
        /**
    ...
    export interface V1alpha1RevisionReference {
        commit?: /* CommitMetadata contains metadata about a commit that is related in some way to another commit. */ V1alpha1CommitMetadata;
    }
    /**
...
declare namespace Paths {
    ...
    namespace ApplicationServiceGetOCIMetadata {
        namespace Parameters {
            /**
             * the application's namespace.
             */
        ...
        namespace Responses {
            export type $200 = /* OCIMetadata contains metadata for a specific revision in an OCI repository */ ArgoCD.V1alpha1OCIMetadata;
            export type Default = ArgoCD.RuntimeError;
        }
    }
    ...
    namespace ApplicationServiceResourceTree {
        ...
        namespace Responses {
            export type $200 = /* ApplicationTree represents the hierarchical structure of resources associated with an Argo CD application. */ ArgoCD.V1alpha1ApplicationTree;
            export type Default = ArgoCD.RuntimeError;
        }
    }
    ...
    namespace ApplicationServiceRunResourceActionV2 {
        export interface BodyParameters {
            body: Parameters.Body;
        }
        namespace Parameters {
            export type Body = ArgoCD.ApplicationResourceActionRunRequestV2;
            export type Name = string;
        }
        export interface PathParameters {
            name: Parameters.Name;
    ...
    namespace ApplicationServiceWatchResourceTree {
        ...
        namespace Responses {
            ...
            export interface $200 {
                error?: ArgoCD.RuntimeStreamError;
                result?: /* ApplicationTree represents the hierarchical structure of resources associated with an Argo CD application. */ ArgoCD.V1alpha1ApplicationTree;
            }
            export type Default = ArgoCD.RuntimeError;
        }
    }
    ...
    namespace RepositoryServiceListOCITags {
        namespace Parameters {
            /**
             * App project for query.
             */
    ...
    namespace RepositoryServiceValidateAccess {
        ...
        namespace Parameters {
             ...
             */
            export type InsecureOciForceHttp = boolean;
            /**
             ...
             */
            export type UseAzureWorkloadIdentity = boolean;
            /**
        ...
        export interface QueryParameters {
            ...
            useAzureWorkloadIdentity?: /* Whether to use azure workload identity for authentication. */ Parameters.UseAzureWorkloadIdentity;
            bearerToken?: /* BearerToken contains the bearer token used for Git auth at the repo server. */ Parameters.BearerToken;
            insecureOciForceHttp?: /* Whether https should be disabled for an OCI repo. */ Parameters.InsecureOciForceHttp;
        }
        namespace Responses {
            export type $200 = ArgoCD.RepositoryRepoResponse;
            export type Default = ArgoCD.RuntimeError;
