...
* **agent:** clarify application scope in system prompt ([#35](https://github.com/alexandrevilain/argo-cd-assistant/issues/35)) ([a66dc79](https://github.com/alexandrevilain/argo-cd-assistant/commit/a66dc79cb846bbbaab7e30f2864851696a9c2555))
* **messages:** add syntax highlighting and GFM support to markdown rendering and enable vertical scrolling for expanded reasoning content ([fa41253](https://github.com/alexandrevilain/argo-cd-assistant/commit/fa41253f62807398bcd367194149cd96e900ca92))

## [0.1.0](https://github.com/alexandrevilain/argo-cd-assistant/compare/v0.0.2...v0.1.0) (2025-11-08)
...
* **ui:** add Reasoning support ([#32](https://github.com/alexandrevilain/argo-cd-assistant/issues/32)) ([5e09471](https://github.com/alexandrevilain/argo-cd-assistant/commit/5e09471dabd81e9d6ed94f66dd0fe3101d0e6a40))
